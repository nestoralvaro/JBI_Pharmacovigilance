#!/usr/bin/python
"""
  Script downloaded from http://diego.asu.edu/downloads/download_binary_twitter_data.py
  The only modification has been performed on line 14
"""
...
try:
    for line in open(sys.argv[1]):
        ...
        tweetid = fields[0]
        userid = "twitter" # userid = fields[1]
        tweet = None
        text = "Not Available"
